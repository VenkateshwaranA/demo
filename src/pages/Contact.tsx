...
const Contact = () => {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-primary to-secondary text-white pt-32 pb-16 md:pt-40">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-gray-600">
                        123 Digital Drive, Web City, WC 12345
                      </p>
                    </div>
                  </div>
          ...
          <div className="mx-auto grid max-w-3xl gap-6">
            ...
            <div className="animate-fade-in rounded-lg bg-white p-6 shadow">
              ...
              <p className="mt-2 text-gray-600">
                ...
                site might take 1-2 months. We'll provide a detailed timeline during our initial consultation.
              </p>
            </div>
